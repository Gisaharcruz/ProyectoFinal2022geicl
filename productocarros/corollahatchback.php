...
<head>
    ...
    <title>Toyota Corolla Hatchback</title>
</head>
<body>
    <header class="hero">
        <nav class="nav__hero">
            <div class="container nav__container">
                <div class="logo">
                    <h2 class="logo__name">Toyota Corolla Hatchback<span class="point">.</span></h2>
                </div>
                <div class="links">
        ...
        <section class="container hero_main">
            <div class="hero__textos">
                <h1 class="title">Datos Tecnicos del <span class="title--active">Toyota Corolla Hatchback.</span></h1>
            ...
            <center><img src="../images/corolla__hatchback.jfif" class="mockup"></center>
        </section>
    </header>
