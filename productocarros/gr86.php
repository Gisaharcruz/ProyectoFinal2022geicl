    ...
    <header class="hero">
        <nav class="nav__hero">
            <div class="container nav__container">
                <div class="logo">
                    <h2 class="logo__name">Toyota GR86<span class="point">.</span></h2>
                </div>
                <div class="links">
        ...
        <section class="container hero_main">
            <div class="hero__textos">
                <h1 class="title">Datos Tecnicos del <span class="title--active">Toyota GR86.</span></h1>
            ...
            <center><img src="../images/gr86.jpg" class="mockup"></center>
        </section>
    </header>
    ...
    <main>
        <section class="services">
            <div class="container">
                ...
                <article class="container-card">
                    <div class="card">
                        <img src="../images/gr863.jfif" class="card__img">
                        ...
                        <div class="card">
                        <img src="../images/gr864.jfif" class="card__img">
                        <div class="cards__text">
                            <p class="card__list">Especialidades en carros toyota</p>
                            <h3 class="card__title">Web Toyota<span class="point">.</span></h3>
                            <p class="card__copy">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Necessitatibus deserunt sit soluta enim quidem accusantium, commodi ad similique optio ipsam beatae maiores voluptate odit officia vel molestias, officiis ducimus nam.</p>
                        ...
                        <div class="card">
                        <img src="../images/gr865.jfif" class="card__img">
                        <div class="cards__text">
                            <p class="card__list">Especialidades en carros toyota</p>
                            <h3 class="card__title">Web Toyota<span class="point">.</span></h3>
                            <p class="card__copy">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Necessitatibus deserunt sit soluta enim quidem accusantium, commodi ad similique optio ipsam beatae maiores voluptate odit officia vel molestias, officiis ducimus nam.</p>
        ...
        <section class="proyects container">
            ...
            <div class="background">
                <img src="../images/gr861.jfif" class="background__img">
                <div class="background__text">
                <h3 class="background__title">El mejor Toyota GR86 del 2022</h3>
            ...
            <div class="background">
                <img src="../images/gr862.jfif" class="background__img">
                <div class="background__text">
                <h3 class="background__title">El mejor Toyota GR86 del 2022</h3>
                <p class="background__copy">Tu experiencia aumenta con Toyota</p>
                </div>
